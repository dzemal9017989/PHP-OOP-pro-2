...
$patient = new Patient("Dzemal Nikocevic", "Red", "Blauw", 180, 75);
$doctor = new Doctor("Doktor, Allstar", "Wit", "Oranje", 185, 80, 50);
$nurse = new Nurse("Zuster Annelies", "Zwart", "Groen", 170, 60, 30);
